                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Text(
                          foodStatus(snapshot.data?['status'] ?? 0),
                          style: GoogleFonts.openSans(
                            color: statusColor(snapshot.data?['status'] ?? 0),
                            fontWeight: FontWeight.w400,
                            fontSize: 11.sp,
                          ),
                        )
                      ...
                      children: [
                        Padding(
                          ...
                          child: Column(
                            children: [
                              Text(
                                widget.orderCardModel.orderId.toString(),
                                style: GoogleFonts.openSans(
                                  color: const Color.fromRGBO(225, 225, 225, 1),
                        ...
                        Column(
                          children: [
                            Text(
                              widget.orderCardModel.itemCount.toString(),
                              style: GoogleFonts.openSans(
                                color: const Color.fromRGBO(225, 225, 225, 1),
                                fontWeight: FontWeight.w600,
                                fontSize: 16.sp,
