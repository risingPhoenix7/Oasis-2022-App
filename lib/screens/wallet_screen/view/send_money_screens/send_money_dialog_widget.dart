...
class SendMoneyDialogBox extends StatefulWidget {
  const SendMoneyDialogBox(
  ...
  @override
  State<SendMoneyDialogBox> createState() => _AddMoneyDialogBoxState();
}

class _AddMoneyDialogBoxState extends State<SendMoneyDialogBox> {
  String time = '';
  String date = '';
