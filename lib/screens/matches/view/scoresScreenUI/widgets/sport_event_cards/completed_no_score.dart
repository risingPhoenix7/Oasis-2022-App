...
class CompletedNoScore extends StatelessWidget {
  CompletedNoScore({Key? key, required this.roundData}) : super(key: key);
      ...
      child: Stack(
        children: [
          Container(
            ...
            height: UIUtills().getProportionalHeight(height: 142),
            child: Column(
              // mainAxisAlignment: MainAxisAlignment.center,
              // crossAxisAlignment: CrossAxisAlignment.center,
              children: [
                SizedBox(
                  height: UIUtills().getProportionalHeight(height: 12.00),
                ),
                Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Image.asset(
                        ...
                        height: UIUtills().getProportionalHeight(height: 16),
                        width: UIUtills().getProportionalHeight(height: 16),
                      ),
                    ),
                    Text(
                ...
                SizedBox(
                  height: UIUtills().getProportionalHeight(height: 8),
                ),
                Text('Result will be updated soon'),
                SizedBox(
                  height: UIUtills().getProportionalHeight(height: 8),
                ),
                Row(
