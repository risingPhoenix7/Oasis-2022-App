                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            ...
                            IconButton(
                                ...
                                icon: SvgPicture.asset('assets/images/3gole.svg'))
                          ],
                        ),
                        Container(
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        ...
                                        Container(
                                          width: 250.w,
                                          child: Text(
                                            capitalizeAllWord(UserDetailsViewModel
                        ...
                        Padding(
                         ...
                         WalletViewModel.isKindActive
                            ...
                            : Container(),
                        Padding(
                          padding: EdgeInsets.only(top: 35.h, bottom: 22.h),
                          child: Text(
                            'Transactions',
                            style: GoogleFonts.openSans(
                                color: Colors.white,
                                ...
                                return Padding(
                                  ...
                                  child: Container(
                                    child: Padding(
                                      ...
                                      child: Row(
                                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                        children: [ if(groupedTransactions[index].txn_type == 'prof_show')
                                          SizedBox(height: 73.h,width:73.w,child: SvgPicture.asset('assets/images/ticket_image.svg',height: 30.h,width: 50.w,)
                                    ) else if(groupedTransactions[index].txn_type == 'merch')
                                            SizedBox(height: 73.h,width:73.w,child: SvgPicture.asset('assets/images/hangar.svg',height: 30.h,width: 50.w,)
                                            )else SizedBox(height: 73.h,width:73.w,child: SvgPicture.asset('assets/images/money_transfer.svg',height: 30.h,width: 50.w,))
                                          ,
                                          Column(crossAxisAlignment: CrossAxisAlignment.start,
                                            ...
                                            Padding(
                                              ...
                                              child: Container(
                                                width: 171.w,
                                                child: Text(groupedTransactions[index].name ?? 'lol',style: GoogleFonts.openSans(
                                                    color: Colors.white,
                                                    fontSize: 14.sp,
                                            ...
                                            Text(DateFormat.MMMd().add_jm().format(DateTime.parse(dateAndTime
                                              (groupedTransactions[index].time ?? ''))).toString() ?? 'lol',style: GoogleFonts.openSans(
                                                color: Color.fromRGBO(255, 255, 255, 1),
                                                fontSize: 12.sp,

                                                fontWeight: FontWeight.w400),),
                                          ],),
                                          if(groupedTransactions[index].txn_type == 'Transfer')
                                          Text('₹${groupedTransactions[index].price!.toString()}',style: GoogleFonts.openSans(
                                              color: Colors.white,
                                              fontSize: 18.sp,

                                              fontWeight: FontWeight.w700),)
                                          else if(groupedTransactions[index].txn_type == 'Add from SWD')
                                            Text('+ ₹${groupedTransactions[index].price!.toString()}',style: GoogleFonts.openSans(
                                                color: Colors.green,
                                                fontSize: 18.sp,

                                                fontWeight: FontWeight.w700),)
                                          else  Text('- ₹${groupedTransactions[index].price!.toString()}',style: GoogleFonts.openSans(
                                                color: Colors.red,
                                                fontSize: 18.sp,
