...
part of 'get_questions_retrofit.dart';
...
class _QuestionsRestClient implements QuestionsRestClient {
  _QuestionsRestClient(
    this._dio, {
    this.baseUrl,
  }) {
  ...
  @override
  Future<Questions> getAllQuestions(JWT) async {
