...
class UpcomingEmptyCard extends StatelessWidget {
  UpcomingEmptyCard({Key? key, required this.roundData}) : super(key: key);
      ...
      child: Stack(
        children: [
          Container(
            ...
            height: UIUtills().getProportionalHeight(height: 83),
            child: Column(
              children: [
                SizedBox(
