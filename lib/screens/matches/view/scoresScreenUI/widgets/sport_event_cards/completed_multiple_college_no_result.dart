...
class CompletedMultipleCollegeNoResult extends StatelessWidget {
  CompletedMultipleCollegeNoResult({Key? key, required this.roundData})
      : super(key: key);
        ...
        children: [
          Container(
            ...
            height: UIUtills().getProportionalHeight(
                height: 130 + 220 * collegeAndplayerList.length / 8),
            child: Column(
              children: [
                SizedBox(
