...
class UpcomingCollege extends StatelessWidget {
  UpcomingCollege({Key? key, required this.roundData}) : super(key: key);
      ...
      child: Stack(
        children: [
          Container(
            ...
            height: UIUtills().getProportionalHeight(height: 116),
            child: Column(
              children: [
                SizedBox(
